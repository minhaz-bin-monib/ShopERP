...
@section('main-section')
    ...
    <div class="container-fluid cat-list-wrap">
        <div class="cat-list-shell">
            <div class="cat-list-head">
                <div>
                    <h2 class="cat-title">Customer List</h2>
                </div>
                <div class="cat-head-actions">
                    <div class="cat-chip"><span></span>{{ $customers->count() }} total</div>
                </div>
            </div>
                ...
                <table id="myTable" class="table table-borderless">
                    ...
                    <tbody>
                        @foreach($customers as $prod)
                            <tr>
                                <td style="width: 56px;">{{ $prod->customer_id }}</td>
                                <td style="width: 52px;">
                                    <a class="cat-edit" href="{{url('/customer/edit')}}/{{$prod->customer_id}}"><i class="fa fa-edit"></i></a>
                                </td>
                                ...
                                <td>0</td>
                                <td>
                                    <span class="cat-status {{ $prod->customer_status === 'Active' ? 'cat-active' : 'cat-inactive' }}">
                                        {{ $prod->customer_status }}
                                    </span>
                                </td>
                            </tr>
                        @endforeach
    ...
    <script type="text/javascript">
        ...
        if (pageName) {
            pageName.innerText = 'Customer List';
        }
