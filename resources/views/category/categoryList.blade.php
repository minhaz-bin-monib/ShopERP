...
@section('main-section')
    ...
    <div class="container-fluid cat-list-wrap">
        <div class="cat-list-shell">
            <div class="cat-list-head">
                <div>
                    <h2 class="cat-title">Category List</h2>
                </div>
                <div class="cat-head-actions">
                    <div class="cat-chip"><span></span>{{ $categorys->count() }} total</div>
                </div>
            </div>
            ...
            <tbody>
                ...
                <tr>
                    <td style="width: 56px;">{{ $prod->category_id }}</td>
                    <td style="width: 52px;">
                        <a class="cat-edit" href="{{url('/category/edit')}}/{{$prod->category_id}}"><i class="fa fa-edit"></i></a> 
                    </td>
                    <td>{{$prod->category_name}}</td>
                    <td>
                        <span class="cat-status {{ $prod->category_status === 'Active' ? 'cat-active' : 'cat-inactive' }}">
                            {{ $prod->category_status }}
                        </span>
                    </td>
                    {{-- <td style="width: 7%"> 
    ...
    if (pageName) {
        pageName.innerText = 'Category List';
    }
