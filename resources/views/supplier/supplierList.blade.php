...
@section('main-section')
    ...
    <div class="container-fluid cat-list-wrap">
        <div class="cat-list-shell">
            <div class="cat-list-head">
                <div>
                    <h2 class="cat-title">Supplier List</h2>
                </div>
                <div class="cat-head-actions">
                    <div class="cat-chip"><span></span>{{ $suppliers->count() }} total</div>
                </div>
            </div>
            ...
            <div class="cat-table-wrap">
                <table id="myTable" class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 56px;">{{ $prod->supplier_id }}</td>
                            <td style="width: 52px;">
                                <a class="cat-edit" href="{{url('/supplier/edit')}}/{{$prod->supplier_id}}"><i class="fa fa-edit"></i></a>
                            </td>
                            ...
                            <td>
                                <span class="cat-status {{ $prod->supplier_status === 'Active' ? 'cat-active' : 'cat-inactive' }}">
                                    {{ $prod->supplier_status }}
                                </span>
                            </td>
                        </tr>
                       @endforeach
    ...
    <script type="text/javascript">
        ...
        if (pageName) {
            pageName.innerText = 'Supplier List';
        }
