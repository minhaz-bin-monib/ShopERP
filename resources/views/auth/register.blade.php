...
<div class="auth-wrap">
    <div class="auth-card">
        ...
        <div class="auth-body">
            <img class="auth-logo" src="{{ url('/') }}/img/print_logo.png" alt="Logo">
            <form action="{{ url('/register') }}" method="post">
                ...
                <div class="form-row">
                    <div class="mb-2">
                        <label class="auth-label" for="name">Role <span class="text-danger"><b>*</b></span></label>
                        <select name="name" class="form-control auth-input">
                            <option value="Admin"
                    ...
                    <div class="mb-2">
                        ...
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" class="form-control auth-input"
                            id="email">
