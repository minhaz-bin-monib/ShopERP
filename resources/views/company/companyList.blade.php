...
@section('main-section')
    ...
    <div class="container-fluid cat-list-wrap">
        <div class="cat-list-shell">
            <div class="cat-list-head">
                <div>
                    <h2 class="cat-title">Company List</h2>
                </div>
                <div class="cat-head-actions">
                    <div class="cat-chip"><span></span>{{ $companies->count() }} total</div>
                </div>
            </div>
            ...
            <div class="cat-table-wrap">
                <table id="myTable" class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 56px;">{{ $prod->company_id }}</td>
                            <td style="width: 52px;">
                                <a class="cat-edit" href="{{url('/company/edit')}}/{{$prod->company_id}}"><i class="fa fa-edit"></i></a>
                            </td>
                            <td>{{$prod->company_name}}</td>
                            <td>{{$prod->company_code}}</td>
                            <td>
                                <span class="cat-status {{ $prod->company_status === 'Active' ? 'cat-active' : 'cat-inactive' }}">
                                    {{ $prod->company_status }}
                                </span>
                            </td>
                        </tr>
    ...
    <script type="text/javascript">
        ...
        if (pageName) {
            pageName.innerText = 'Company List';
        }
